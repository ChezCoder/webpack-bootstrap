...
const Square1_1 = require("../SceneObjects/Square1");
class default_1 extends Scene_1.default {
    ...
    setup() {
        this.resource.save("webpack", new Resource_1.ImageResource("./assets/images/webpack.png"));
        this.addRenderable(new Square1_1.Square1(this, Util_1.Random.random(0, 200) / 100, 210, Util_1.Color.Enum.GRAY));
        this.addRenderable(new Square1_1.Square1(this, -Util_1.Random.random(0, 200) / 100, 200, Util_1.Color.Enum.DIM_GRAY));
    }
    loop() {
        this.draw({
            "draw": ctx => {
        ...
        this.draw({
            "fillStyle": new Util_1.Color.Hex(0xff0000).toString(),
        ...
        Util_1.TextHelper.writeCenteredTextAt(this, "Demo Scene!", {
